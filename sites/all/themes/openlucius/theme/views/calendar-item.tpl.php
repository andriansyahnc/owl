 ...
 */
$index = 0;
$type = isset($item->row->_field_data['nid']['entity']->type) ? $item->row->_field_data['nid']['entity']->type : '';
?>
<div class="<?php print !empty($item->class) ? $item->class : 'item'; ?> openlucius-calendar-item <?php print $type; ?>" data-nid="<?php print $item->id; ?>" data-token="<?php print drupal_get_token(); ?>">
